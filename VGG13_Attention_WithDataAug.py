...
class CustomizedVGG(nn.Module):
  def __init__(self,inChannels=1,embSize=512,noClasses=1251):
    ...
    self.multiHeadAttn=nn.MultiheadAttention(embed_dim=512, num_heads=8)
  ...
  def forward(self,input,preTrainingFlag=0):
    ...
    convOutput,convWeights = self.multiHeadAttn((pos + convOutput),(pos + convOutput),(pos + convOutput))
